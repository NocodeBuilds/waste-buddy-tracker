  ...
  return (
    <div className="space-y-4">
      ...
      <DashboardCard>
        ...
        {isAdmin && (
          <form onSubmit={handleCreateSite} className="space-y-3 border-t pt-3">
            <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Create new site</h3>
      ...
      {isAdmin && currentSite && (
        <DashboardCard>
          ...
          <div className="border-t pt-3">
            <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Site Members ({members.length})</h3>
      ...
      {/* Data export */}
      <DashboardCard>
        <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Data Export</h3>
